...
\begin{center}
	...
	\vfill
	\visible<4->{\framezoom<4><5>(0.65\textwidth, 3.594cm)(0.2\textwidth, 2.8cm)
				 \includegraphics[width=0.75\textwidth,keepaspectratio]{densityEstimation.pdf}}
	\vfill
	\visible<6->{\framezoom<6><7>(0.65\textwidth, 5.58cm)(0.35\textwidth, 1cm)
				 \includegraphics[width=0.75\textwidth,keepaspectratio]{PCA.pdf}}
\end{center}
\end{columns}
\end{frame}
...
\begin{center}
	\visible<2->{\includegraphics[width=1\textwidth]{classification.pdf}}
	\vfill
	\visible<3->{\includegraphics[width=1\textwidth]{regression.pdf}}
\end{center}
\end{columns}
\end{frame}
