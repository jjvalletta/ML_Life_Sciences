...
\end{center}
% Mention that it's a good example of limitation of statistics when analysing this data
\end{frame}
%-------------------------------------------------------------------------------------------------%
\begin{frame}{Where is clustering used?}
\begin{description}[Mathematical chemistry:]\addtolength{\itemsep}{0.1\baselineskip}
...
\begin{frame}{$k$-means clustering}
	\begin{center}
		\includegraphics<1>[width=\textwidth]{iteration1.pdf}
		\includegraphics<2>[width=\textwidth]{iteration2.pdf}
		\includegraphics<3>[width=\textwidth]{iteration3.pdf}
		\includegraphics<4>[width=\textwidth]{iteration4.pdf}
		\includegraphics<5>[width=\textwidth]{iteration5.pdf}
		\includegraphics<6>[width=\textwidth]{iteration6.pdf}
		\includegraphics<7>[width=\textwidth]{iteration7.pdf}
		\includegraphics<8>[width=\textwidth]{iteration8.pdf}
	\end{center}
\end{frame}
%-------------------------------------------------------------------------------------------------%
\begin{frame}{$k$-means clustering}
